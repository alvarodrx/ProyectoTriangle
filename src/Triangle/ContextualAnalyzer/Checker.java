...
import Triangle.AbstractSyntaxTrees.ListaLiterales;
...
public final class Checker implements Visitor {
	...
	public Object visitSingleCaseLiteral(SingleCaseLiteral ast, Object o) {
		TypeDenoter eType = (TypeDenoter) ast.T.visit(this, o);
		int sucess = ll.ingresaLiteral(ast.T, eType);
		if(sucess == 1){
			reporter.reportError("The type of the literal is not compatible with the expression", "",
					ast.T.position);
			return StdEnvironment.errorType;
		}
		if(sucess == 2){
			reporter.reportError("The literal is already in the list", "",
					ast.T.position);
			return StdEnvironment.errorType;
		}
		return null;
	...
	public Object visitSequentialCaseLiteral(SequentialCaseLiteral ast, Object o) {
		ArrayList<SingleCaseLiteral> ListaLit;
	...
	public Object visitLocalCompoundDeclaration(LocalCompoundDeclaration ast, Object o) {
		idTable.initLocalScope();
		ast.D1.visit(this, null);
		idTable.initLocalDecScope();
		ast.D2.visit(this, null);
		idTable.finishLocalScope();
		return null;
	}
