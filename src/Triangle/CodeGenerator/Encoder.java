...
public final class Encoder implements Visitor {
	...
	public Object visitForCommand(ForCommand ast, Object o) {	//Este codigo no esta revisado. Se agrega para saltar el error pero no esta bien
		Frame frame = (Frame) o;
		int jumpifAddr, jumpAddr;

		Integer valSize = (Integer) ast.I.visit(this, frame);
	...
	public Object visitSequentialDeclaration(SequentialDeclaration ast, Object o) {
		...
		@Override//No probado aun -------- Podria no funcionar 
	public Object visitSequentialCaseLiteral(SequentialCaseLiteral ast, Object o) {
		Frame frame = (Frame) o;
		int extraSize1, extraSize2;

		extraSize1 = ((Integer) ast.T1.visit(this, frame)).intValue();
		Frame frame1 = new Frame(frame, extraSize1);
		extraSize2 = ((Integer) ast.T2.visit(this, frame1)).intValue();
		return new Integer(extraSize1 + extraSize2);
	}
